...
function Probs({username, price="12000",btn="Search"}) {
    //console.log(username)
    return (
        <div>
            <div className="mb-4   flex font-serif">
                <div className=" flex-none w-52 relative">
                    <img src="https://images.pexels.com/photos/20452012/pexels-photo-20452012/free-photo-of-woman-sitting-in-traditional-clothing-and-with-painting-behind.jpeg?auto=compress&cs=tinysrgb&w=400&lazy=load" alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
                </div>
                <form className="bg-white flex-auto p-6">
                    ...
                    <div className="flex space-x-4 mb-5 text-sm font-medium">
                        <div className="flex-auto flex space-x-4 pr-4">
                            ...
                            <button className="text-white  flex-none w-1/2 h-12 uppercase font-medium tracking-wider border border-slate-200 text-slate-900" type="button">
                                Add to bag
                            </button>
                        </div>
